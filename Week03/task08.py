...
def main() -> None:
    learning_rate = 0.01 # 0.0001 <= lr <= 1
    momentum = 0.94 # 0.5 <= m <= 0.99
    optimize_and_plot(lr=learning_rate, momentum=momentum) 
    # Not the same as the image but this is what I got closest to
